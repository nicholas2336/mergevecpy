"""
File: mergevec.py 
Original_Author: blake.w.wulfe@gmail.com 
Edited_Author: bobby.nicholas23@gmail.com
Date: 4/21/2016
File Description:
	...
	note :
	- If each img file larger than 1MB and the code won't running try to compress it before make a vec file
	- If the file won't running check the samples directory or the vec directory, the code won't running if inside the directory have file vec with 0kb size
"""
